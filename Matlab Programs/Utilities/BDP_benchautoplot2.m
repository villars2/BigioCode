...
for qq=1:numel(pseries)
    eval(['plot(pdate,(' char(pseries(qq)) '(pindex)/' char(pseries(qq)) '(pbench))*100,''LineWidth'',Width' num2str(qq) ',''Color'',DataColor' num2str(qq) ',''Marker'',Marker' num2str(qq) ',''MarkerSize'',MkS' num2str(qq) ');']) 
end
