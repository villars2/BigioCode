%% FRED Upload Data - FRC_FRED_data_upload_v6
% (c) Adapted from Matlab's Data Download Toolbox by Saki Bigio
% Columbia Graduate School of Busines - 2014
%
% Log of modifications:
% 	01/31/2013: delete all the unused code or comments
%   06/2014: added implementation of Matlab utilities. 
%
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Overview. This code downloads ECONOMIC data from FRED, the Federeal
% Reserve Bank of St. Louis Data System. 
%
% The code works with the data
%
% FRED Series     Description
% -----------     ----------------------------------------------------------------
% CORE QUANTITIES AND PRICES -> REAL 
% -----------     ----------------------------------------------------------------
...
% -----------     ----------------------------------------------------------------
% MONETARY AGGREGATES AND RATES -> MONEY
% -----------     ----------------------------------------------------------------
...
% -----------     ----------------------------------------------------------------
% General Banking Sector Condtions -> BANKING
% -----------     ----------------------------------------------------------------
% EQTA            Total Equity to Assets
% USROE           Return on Equity
% USROA           Return on Assets
% USNIM           Net Interest Margin
% NPTLTL          Non-performing to Total Loans
% USLLRTL         Loan Loss Reserve
% NCOTOT          Total Net Charge-Offs (Loan-Recovery)
% LLRNPT          Assets whose ALLL exceeds NP
% USLSTL          Net Loan Losses/ Total Loans
% NCOMC           Commercial Loan Net Charge-off
% NPCMCM          Non-performing commercial loans
% FREQ            Banks #
% FREQS           Banks # of Domestic
...
% VIXCLS          U.S. VIX Index
% -----------     ----------------------------------------------------------------
% LOANS DETAIL    -> LOANS
% -----------     ----------------------------------------------------------------
% TOTLL           Total Loans and Leases
% BUSLOANS        Commercial Loans and Leases
% REALLN          Real Estate Loans and Leases
% CONSUMER        Consumer Loans
% LOANS           Loans and Leases at Banks
% LOANINV         Loans and Investments
% -----------     ----------------------------------------------------------------
% BANK SECURITIES AND INVESTMENTS -> BANKSEC
% -----------     ----------------------------------------------------------------
% USSEC           U.S. Bank investments in secuturities
% INSVEST         Total Investment
% OTHSEC          Other Securities
% -----------     ----------------------------------------------------------------
% SENIOR BANK OFFICER SURVEY -> SLO
% -----------     ----------------------------------------------------------------
% ............    ----------------------------------------------------------------
% QUESTION TYPE       DESCRIPTOR     
% ............    ----------------------------------------------------------------
% DRTS            Declaring tightening standards
% DRSD              Declarign Stronger Demand
% ............    ----------------------------------------------------------------
% CATEGORY TYPE       DESCRIPTOR     
% ............    ----------------------------------------------------------------
% CILM        Large and medium sized firms
% CIS         Small sized firms
% CREL        Commertial real estate loans
% PM          Prime Mortgage loans
% ............    ----------------------------------------------------------------
% QUESTION TYPE       DESCRIPTOR     
% ............    ----------------------------------------------------------------
% DRTS        Domestic respondents tightening standards
% DRSD        Domestic respondents reporting stronger demand
% %%%%
% -----------     ----------------------------------------------------------------
% SURVEY LENDING TERMS-> SLT
% -----------     ----------------------------------------------------------------
% -----------     ----------------------------------------------------------------
% LOANS TO C&I FIRMS - NQ (NA adjusted quarterly)
% ............    ----------------------------------------------------------------
% RISK RATE       DESCRIPTOR     
% ............    ----------------------------------------------------------------
% MINIMAL         N
% LOW             L
% MEDIUM          M
...
% BOND RATINGS    -> BONDS
% ............    ----------------------------------------------------------------
% BANK OF AMERICA MERRILL LYNCH (corporate yields)
% ............    ----------------------------------------------------------------
% AAA             BAMLC0A1CAAAEY
% AA              BAMLC0A2CAAEY
% A               BAMLC0A3CAEY
...
% BAA             BAA
% ------------    ----------------------------------------------------------------
% COMMERCIAL PAPER -> BANKSEC
% ------------    ----------------------------------------------------------------
% OUT. FIN        FINCP
% OUT. NONFIN     COMPAPER
% OUT. Asset Back ABCOMP
% RATE 1 Month NF CPN1M
% RATE 2 Month NF CPN2M
% RATE 3 Month NF CPN3M
% RATE 1 Month F  CPF1M
% RATE 2 Month F  CPF2M
% RATE 3 Month F  CPF3M
% ------------    ----------------------------------------------------------------
% FLOW OF FUNDS - BALANCE SHEET OF CORPORATIONS -> FOF_CORP
% ------------    ----------------------------------------------------------------
% ............    ----------------------------------------------------------------
% ASSET SIDE      TABSNNCB
% ............    ----------------------------------------------------------------
% Total Asetts    TABSNNCB
% Fin. Asetts     TFAABSNNCB
% Acc. Re         TRABSNNCB
% Fin. Invs.      
% Tangible Astt   TTABSNNCB 
%   Inventory     IABSNNCB  
%	Mach. & Eqp.  ESABSNNCB
%   Real Estate   REABSNNCB
% ............    ----------------------------------------------------------------
% LIABILITY SIDE  TLBSNNCB
% ............    ----------------------------------------------------------------
% Credit Inst.    TCMILBSNNCB
%   Loans N.E.C   BLNECLBSNNCB
%   CP            CPLBSNNCB
%   Bonds         CBLBSNNCB
%   Mortgages     MLBSNNCB
% Acc. Pay        TPLBSNNCB
% Taxes Owed      TXLBSNNCB
% ------------    ----------------------------------------------------------------
% FLOW OF FUNDS - BALANCE SHEET OF NON-FARM NON-CORPORATE -> FOF_NONCORP
% ------------    ---------------------------------------------------------------- 
% ............    ----------------------------------------------------------------
% ASSET SIDE      TABSNNCB
% ............    ----------------------------------------------------------------
% Total Asetts    TABSNNB
% Fin. Asetts     TFAABSNNB
% Acc. Re         TRABSNNB
% Fin. Invs.      TFAABSNNB
% Tangible Astt   TTABSNNB 
%   Inventory     IABSNNB  
%	Mach. & Eqp.  ESABSNNB
%   Real Estate   REABSNNB
% ............    ----------------------------------------------------------------
% LIABILITY SIDE  TLBSNNCB
% ............    ----------------------------------------------------------------
% Credit Inst.    TCMILBSNNNB
%   Loans N.E.C   BLNECLBSNNB
%   Mortgages     MLBSNNNB
% Acc. Pay        TPLBSNNNB
% Taxes Owed      TXLBSNNNB
% ............    ----------------------------------------------------------------
% Housing Data    
% ............    ----------------------------------------------------------------
% 20-city CS IndexSPCS20RSA
% US Hm ownerhsip USHOWN
% Boston CS index BOXRSA
% Chicago ''      CHXRSA
% L.A.    ''      LXXRSA
% Miami   ''      MIXRSA
% NYC     ''      NYXRSA
...
% W. DC   ''      WDXRSA
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% More variables to construct tables in paper
%
% loans               BUSLOANS        monthly sa
% reserves_1          ADJRESNS        monthly nsa
% reserves_2          WRESBAL         weekly  nsa
% deposit             DEMDEPSL        monthly sa
% interbank lending   IBLACBM027SBOG  monthly sa  
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Home price indexes
hprices={'SPCS20RSA','USHOWN'};
cities={'BO','CH','LX','MI','NY','SF','WD'};
for i=1:numel(cities),
    eval(['hprices=[hprices {''' cities{i} 'XRSA''}];' ])
end

% Adding Data from Flow of Funds
series = [loanseries bondseries bcseries cpseries realqs sloseries table hprices {'GDP','FEDFUNDS','COE', 'CPIAUCSL',...
             'GCE', 'GDPDEF', 'GPDI', ...
...
series2log=[{'GDP','TOTLL','BUSLOANS','REALLN','CONSUMER','LOANS','LOANINV','USGSEC','GDPDEF'}, hprices];
...
% Housing data
USHOWN=(Dataset.USHOWN);
CS20=(Dataset.SPCS20RSA);
...
DateEndTrend=Beg_GreatRec+14; % Date for end of linear trend
DateBegTrend=Beg_GreatRec-1;
DateBegArt=DateBegTrend;
DateEndArt=DateEndTrend;
...
pseries={'SPCS20RSA'};
BDP_autoplot;
title('\bfLog Case-Shiller Price Index');


subplot(2,2,3)
%pseries={'rBOXRSA','rCHXRSA','rLXXRSA','rMIXRSA','rNYXRSA','rSFXRSA','rWDXRSA'};
pseries={'rBOXRSA','rCHXRSA','rLXXRSA','rMIXRSA','rNYXRSA','rSFXRSA'};
BDP_autoplot;
title('\bfGrowth of Home Prices');
h = legend('Boston','Chicago','Los Angeles','Miami','New York','San Francisco','Location','Best');
set(h,'FontSize',7,'Box','off');
ylabel('Q-to-Q % Change')

allindex=[1:length(dates)]';
pdate=intersect(pdate,dates(~isnan(USHOWN)));
pindex=intersect(pindex,allindex(~isnan(USHOWN)));
subplot(2,2,4)
pseries={'USHOWN'};
BDP_autoplot;
title('\bfUS Home Ownership');
ylabel('%')
set(gca,'XTick',[pdate(1:4:end-2); pdate(end)]);
dateaxis('x',12)

orient landscape
saveas(gcf,'F_Housing','pdf');
